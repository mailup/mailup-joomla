 ...
 * MailUP View
 */
class MailUPViewList extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_MAILUP_MANAGER_MAILUP_NEW') : JText::_('COM_MAILUP_MANAGER_MAILUP_EDIT'), 'list');
		...
		if ($isNew) 
		{
			...
			{
				//JToolBarHelper::apply('list.save', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('list.applyList', 'JTOOLBAR_SAVE');
		...
		else
		{
			if ($canDo->get('core.edit'))
			{
				...
				JToolBarHelper::save('list.updateList', 'JTOOLBAR_SAVE');
	...
	protected function setDocument() 
	{
		...
		$document->addScript(JURI::root() . "/administrator/components/com_mailup/views/list/submitbutton.js");
